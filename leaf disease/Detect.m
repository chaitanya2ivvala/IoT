...
figure, imshow(I_Otsu);title('Otsu Tresholding');
% Conversion to HIS
I_HIS = rgb2hsi(I);
figure, imshow(I_HIS);title('HIS image');
%% Extract Features
...
figure, imshow(seg_img);title('segmented images');
...
figure, imshow(black);title('disease affected area');
